	    ...
	    //-->
				...
				<div id="Header">
                    ...
                    <div class="Navigation">
						...
						<span><a id="ctl00_hlMyLUCKBLOX" class="MenuItem" href="user.php">My BLASTBLOX</a></span>
    ...
    ?>
					...
					<div id="EnterUsername">
						...
						<fieldset title="Paste a invite key">
							...
							<legend>BlastBlox invite key</legend>

							<div class="Suggestion">

								You can get a key on the discord server.
					...
					<div id="EnterUsername">
						...
						<fieldset title="Choose a name for your LUCKBLOX character">
							...
							<legend>Choose a name for your BlastBlox character</legend>
					...
					<div id="EnterPassword">
						...
						<fieldset title="Choose your LUCKBLOX password">
							...
							<legend>Choose your BlastBlox password</legend>
		...
		<div id="Sidebars">
			...
			<div id="TermsAndConditions">
				...
				<p>BlastBlox will not share your email address with 3rd parties. See our <a id="ctl00_cphLUCKBLOX_HyperLinkPrivacy" href="privacy.php" target="_blank">Privacy Policy</a> for details.</p>
...
<p class="Legalese">
         ...
         BlastBlox, "Online Building Toy", characters, logos, names, and all related indicia

    are trademarks of ROBLOX,  ©2007-2021. Patents pending.

        <br>BlastBlox is not affliated with ROBLOX, Lego, MegaBloks, Bionicle, Pokemon, Nintendo, Lincoln Logs, Yu Gi Oh, K'nex, Tinkertoys, Erector Set, or the Pirates of the Caribbean. ARrrr!. This is a fan site!
