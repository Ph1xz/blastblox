...
<div class="AspNet-Login">
    ...
    ?>
		...
		<div id="LUCKBLOXAtAGlance">
			...
			<h2>BlastBlox Virtual Playworld</h2>

			<h3>BlastBlox is Free!</h3>
	...
	Works with your<br>Windows PC!
			...
			<div id="ctl00_cphLUCKBLOX_pForParents">
				...
				<div id="ForParents">
					...
					<a id="ctl00_cphLUCKBLOX_hlKidSafe" title="BlastBlox is kid-safe!" href="https://discord.gg/5DGsVHKtVT" style="display:inline-block;"><img title="BlastBlox is kid-safe!" src="textures/discord.png" border="0"></a>
	...
	<tbody><tr>
		...
		<td class="UserPlace">
			...
			<div id="UserPlaces_Header">
				...
				<p>Check out some of our favorite BlastBlox places!</p>
